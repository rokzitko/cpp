...
int main()
{
     {
	std::string a("33");
	auto aa = parse_uint32_t(a);
	std::cout << std::dec << aa << " " << a << std::endl;
     }
     {
	std::string a("0x33");
	auto aa = parse_uint32_t(a);
	std::cout << std::dec << aa << " " << a << " " << std::hex << aa << std::endl;
     }
     {
	std::string a("033");
	auto aa = parse_uint32_t(a);
	std::cout << std::dec << aa << " " << a << " " << std::oct << aa << std::endl;
     }
     {
	std::string a("0b1111");
	auto aa = parse_uint32_t(a);
	std::cout << std::dec << aa << " " << a << " " << std::bitset<32>(aa) << " " << dump(aa) << std::endl;
     }
     {
	std::string a("33");
	auto aa = parse_uint64_t(a);
	std::cout << std::dec << aa << " " << a << std::endl;
     }
     {
	std::string a("0x33");
	...
	std::string a("0b1111");
	auto aa = parse_uint64_t(a);
	std::cout << std::dec << aa << " " << a << " " << std::bitset<64>(aa) << " " << dump(aa) << std::endl;
     }
}
